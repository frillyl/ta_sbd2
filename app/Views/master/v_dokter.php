...
<div class="content-wrapper">
    ...
    <section class="content">
                ...
                <table id="example2" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        foreach ($dokter as $key => $value) { ?>
                            <tr>
                                <td><?= $no++ ?></td>
                                <td><?php if ($value['spesialis'] == 1) {
                                        echo 'Umum';
                                    } elseif ($value['spesialis'] == 2) {
                                        echo 'Gigi';
                                    } elseif ($value['spesialis'] == 3) {
                                        echo 'Anak';
                                    } ?></td>
                                <td><?= $value['nama'] ?></td>
                                <td class="text-center"><img src="<?= base_url('assets/images/pasfoto/' . $value['pasfoto']) ?>" class="img-circle" width="50px" height="50px"></td>
                                <td class="text-center">
                                    <button class="btn btn-info btn-sm" data-toggle="modal" data-target="#info<?= $value['id_dokter'] ?>"><i class="fa-solid fa-circle-info"></i></button>
                                    <button class="btn btn-warning btn-sm" data-toggle="modal" data-target="#edit<?= $value['id_dokter'] ?>"><i class="fa fa-pencil"></i></button>
                                    <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#delete<?= $value['id_dokter'] ?>"><i class="fa fa-trash"></i></button>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
        ...
        <?php foreach ($dokter as $key => $value) { ?>
            <div class="modal fade" id="info<?= $value['id_dokter'] ?>">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <table class="table no-border">
                                <tbody>
                                    <tr>
                                        <th width="200px">Posisi - Spesialis</th>
                                        <td><?php if ($value['posisi'] == 3) {
                                                echo 'Dokter';
                                            } ?> - <?php if ($value['spesialis'] == 1) {
                                                        echo 'Umum';
                                                    } elseif ($value['spesialis'] == 2) {
                                                        echo 'Gigi';
                                                    } elseif ($value['spesialis'] == 3) {
        ...
        <div class="modal fade" id="add">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <?php
                        echo form_open_multipart('master/dokter/add');
                        ?>
                        ...
                        <div class="form-group">
                            <label for="exampleSelectBorderWidth2">Spesialis</label>
                            <select name="spesialis" class="form-control select2bs4">
        ...
        <!-- Modal Edit -->
        <?php foreach ($dokter as $key => $value) { ?>
            <div class="modal fade" id="edit<?= $value['id_dokter'] ?>">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <?php
                            echo form_open_multipart('master/dokter/edit/' . $value['id_dokter']);
                            ?>
                            ...
                            <div class="form-group">
                                <label for="exampleSelectBorderWidth2">Spesialis</label>
                                <select name="spesialis" class="form-control select2bs4">
                                    <option <?php if ($value['spesialis'] == '') {
                                                echo 'selected';
                                            } ?> value="">----- Spesialis -----</option>
                                    <option <?php if ($value['spesialis'] == 1) {
                                                echo 'selected';
                                            } ?> value="1">Umum</option>
                                    <option <?php if ($value['spesialis'] == 2) {
                                                echo 'selected';
                                            } ?> value="2">Gigi</option>
                                    <option <?php if ($value['spesialis'] == 3) {
                                                echo 'selected';
                                            } ?> value="3">Anak</option>
                                </select>
                            </div>
        ...
        <!-- Modal Delete -->
        <?php foreach ($dokter as $key => $value) { ?>
            <div class="modal fade" id="delete<?= $value['id_dokter'] ?>">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            Apakah Anda Yakin Ingin Menghapus Data <b>Dokter <?= $value['nama'] ?></b> ?
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Batal</button>
                            <a href="<?= base_url('master/dokter/delete/' . $value['id_dokter']) ?>" class="btn btn-danger">Hapus</a>
                        </div>
                    </div>
                </div>
            </div>
