...
<div class="content-wrapper">
    ...
    <section class="content">
                        ...
                        foreach ($petugas as $key => $value) { ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <button class="btn btn-info btn-sm" data-toggle="modal" data-target="#info<?= $value['id_petugas'] ?>"><i class="fa-solid fa-circle-info"></i></button>
                                    <button class="btn btn-warning btn-sm" data-toggle="modal" data-target="#edit<?= $value['id_petugas'] ?>"><i class="fa fa-pencil"></i></button>
                                    <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#delete<?= $value['id_petugas'] ?>"><i class="fa fa-trash"></i></button>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
        ...
        <?php foreach ($petugas as $key => $value) { ?>
            <div class="modal fade" id="info<?= $value['id_petugas'] ?>">
        ...
        <div class="modal fade" id="add">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <?php
                        echo form_open_multipart('master/petugas/add');
                        ?>
            ...
            <div class="modal fade" id="edit<?= $value['id_petugas'] ?>">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <?php
                            echo form_open_multipart('master/petugas/edit/' . $value['id_petugas']);
                            ?>
                            ...
                            <div class="form-group">
                                ...
                                <select name="posisi" class="form-control select2bs4">
                                    ...
                                    <option <?php if ($value['posisi'] == 1) {
                                                echo 'selected';
                                            } ?> value="1">Administrator</option>
                                    <option <?php if ($value['posisi'] == 2) {
                                                echo 'selected';
            ...
            <div class="modal fade" id="delete<?= $value['id_petugas'] ?>">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            Apakah Anda Yakin Ingin Menghapus Data <b>Petugas <?= $value['nama'] ?></b> ?
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Batal</button>
                            <a href="<?= base_url('master/petugas/delete/' . $value['id_petugas']) ?>" class="btn btn-danger">Hapus</a>
                        </div>
                    </div>
                </div>
            </div>
