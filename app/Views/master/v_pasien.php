...
<div class="content-wrapper">
    ...
    <section class="content">
                        ...
                        foreach ($pasien as $key => $value) { ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <button class="btn btn-info btn-sm" data-toggle="modal" data-target="#info<?= $value['id_pasien'] ?>"><i class="fa-solid fa-circle-info"></i></button>
                                    <button class="btn btn-warning btn-sm" data-toggle="modal" data-target="#edit<?= $value['id_pasien'] ?>"><i class="fa fa-pencil"></i></button>
                                    <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#delete<?= $value['id_pasien'] ?>"><i class="fa fa-trash"></i></button>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
        ...
        <?php foreach ($pasien as $key => $value) { ?>
            <div class="modal fade" id="info<?= $value['id_pasien'] ?>">
        ...
        <div class="modal fade" id="add">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <?php
                        echo form_open_multipart('master/pasien/add');
                        ?>

                        <div class="form-group">
                            <label for="no_rm">Nomor RM</label>
                            <input type="text" name="no_rm" value="<?= random_string('numeric', 6) ?>" class="form-control" id="no_rm" placeholder="Nomor Rekam Medis" readonly>
                        </div>
                        <div class="form-group">
            ...
            <div class="modal fade" id="edit<?= $value['id_pasien'] ?>">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <?php
                            echo form_open_multipart('master/pasien/edit/' . $value['id_pasien']);
                            ?>

                            <div class="form-group">
                                <label for="no_rm">Nomor RM</label>
                                <input type="text" name="no_rm" value="<?= $value['no_rm'] ?>" class="form-control" id="no_rm" placeholder="Nomor Rekam Medis" readonly>
                            </div>
                            <div class="form-group">
                                <label for="nama">Nama Pasien</label>
            ...
            <div class="modal fade" id="delete<?= $value['id_pasien'] ?>">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            Apakah Anda Yakin Ingin Menghapus Data <b>Pasien <?= $value['nama'] ?></b> ?
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Batal</button>
                            <a href="<?= base_url('master/pasien/delete/' . $value['id_pasien']) ?>" class="btn btn-danger">Hapus</a>
                        </div>
                    </div>
                </div>
            </div>
