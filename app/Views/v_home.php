        ...
        <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
            <div class="container">
                <a href="<?= base_url() ?>/template/index3.html" class="navbar-brand">
                    ...
                    <span class="brand-text font-weight-light"><b> Klinik Pratama Medika</b></span>
                </a>
                ...
                <div class="collapse navbar-collapse order-3" id="navbarCollapse">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('panduan') ?>" class="nav-link">Panduan</a>
                        </li>
                        <li class="nav-item">
                ...
                <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
                    <li class="nav-item">
                        <a class="btn btn-block btn-primary" href="<?= base_url('login') ?>" role="button"><i class="fa-solid fa-right-to-bracket"></i> Masuk</a>
                    </li>
                </ul>
            </div>
        </nav>
        ...
        <div class="content-wrapper">
            ...
            <div class="content">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <img class="img-fluid pad" src="<?= base_url() ?>/assets/images/banner.png" alt="Photo">
                        </div>
                    </div>
                    <!-- /.row -->
                </div><!-- /.container-fluid -->
